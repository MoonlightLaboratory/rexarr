 ...
 */
export function DetailHeader({ backdrop, poster, title, year, endYear, runtimeMinutes, rating, genres, pills, overview, prev, next, attribution, monitored, badges }: { backdrop?: string; poster?: string; title: string; year?: number; endYear?: number; runtimeMinutes?: number; rating?: number; genres: string[]; pills: Pill[]; overview: string; prev?: { to: string; title: string } | null; next?: { to: string; title: string } | null; attribution: string; monitored?: boolean; badges?: ReactNode }) {
  ...
  return (
    <div className="detailHeader">
      ...
      <div className="headerContent">
        <div className="poster" style={{ backgroundImage: poster ? `url(${poster})` : undefined }} />
        <div className="info">
